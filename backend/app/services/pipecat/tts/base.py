"""
TTS Service Base Module.

Defines base classes and utilities for Text-to-Speech service implementations.
"""
import logging
...
class TTSServiceFactory(Protocol):
    """Protocol for TTS service factories."""
