...
var s = function(t) {
  ...
  return d.startCall = function(t2) {
    ...
    this.room.on(RoomEvent.TrackSubscribed, function(n, r3, c2) {
      n.kind === Track.Kind.Audio && n instanceof RemoteAudioTrack && ("agent_audio" === r3.trackName && (e2.emit("call_ready"), t2.emitRawAudioSamples && (e2.analyzerComponent = createAudioAnalyser(n), e2.captureAudioFrame = window.requestAnimationFrame(function() {
